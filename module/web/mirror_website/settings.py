...
try:
    ...
    raise UserWarning("Django secret key must be defined in $SECRET_KEY")

# SECURITY WARNING: don't run with debug turned on in production!
try:
    env_debug = os.environ['DEBUG']
    if env_debug.capitalize() == "TRUE":
        DEBUG = True
    else:
        DEBUG = False
except:
...
# This would normally be a bad idea, but since we're behind nginx anyways we can just leave this
ALLOWED_HOSTS = ["*"]
